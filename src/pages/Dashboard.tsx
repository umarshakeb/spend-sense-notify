...
export default function Dashboard() {
  ...
  if (!user) {
    return (
      <div className="w-full h-full min-h-screen px-3 py-4 sm:px-4 sm:py-8">
        <div className="w-full max-w-6xl mx-auto">
          <Card className="border-none shadow-md bg-gradient-to-br from-primary/10 to-secondary/10 w-full overflow-hidden">
            <CardHeader className="p-4 sm:p-6">
              <CardTitle className="text-xl sm:text-3xl font-bold break-words">Welcome to SpendSense</CardTitle>
            ...
            <CardContent className="p-4 sm:p-6">
              <div className="grid gap-4 sm:gap-6 lg:grid-cols-2 py-4 sm:py-6">
                <div className="space-y-3 sm:space-y-4">
                  <h3 className="text-lg sm:text-xl font-semibold break-words">Track your finances</h3>
                  ...
                  <div className="flex flex-col gap-2 sm:gap-3 pt-2 w-full">
              ...
              <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 pt-4 w-full">
                <Card className="w-full min-w-0">
                  <CardHeader className="p-3 sm:p-6">
                    <CardTitle className="text-base sm:text-lg break-words">SMS Import</CardTitle>
                  </CardHeader>
                  <CardContent className="p-3 sm:p-6 pt-0">
                    <p className="text-xs sm:text-sm text-muted-foreground break-words">
                      Import transactions from SMS and bank notifications
                    </p>
                    <Button variant="ghost" size="sm" className="mt-2 text-xs sm:text-sm w-full sm:w-auto" disabled>
                      Learn More <ArrowRight className="ml-1 h-3 w-3 sm:h-4 sm:w-4 flex-shrink-0" />
                    </Button>
                  </CardContent>
                </Card>
                ...
                <Card className="w-full min-w-0">
                  <CardHeader className="p-3 sm:p-6">
                    <CardTitle className="text-base sm:text-lg break-words">Subscription Alerts</CardTitle>
                  </CardHeader>
                  <CardContent className="p-3 sm:p-6 pt-0">
                    <p className="text-xs sm:text-sm text-muted-foreground break-words">
                ...
                <Card className="w-full min-w-0 col-span-1 sm:col-span-2 lg:col-span-1">
                  <CardHeader className="p-3 sm:p-6">
                    <CardTitle className="text-base sm:text-lg break-words">Usage Tracking</CardTitle>
                  </CardHeader>
                  <CardContent className="p-3 sm:p-6 pt-0">
                    <p className="text-xs sm:text-sm text-muted-foreground break-words">
  ...
  return (
    <div className="w-full h-full min-h-screen px-3 py-4 sm:px-4 sm:py-6 overflow-x-hidden">
      <div className="w-full max-w-7xl mx-auto space-y-4 sm:space-y-6 min-w-0">
        <div className="w-full min-w-0">
          <h1 className="text-xl sm:text-3xl font-bold break-words">{`Welcome back, ${displayName}!`}</h1>
        ...
        {!smsPermissionAsked && !isInitialLoading ? (
          ...
          <div className="flex flex-col gap-3 w-full min-w-0">
            ...
            >
              ...
              <span className="text-xs sm:text-sm truncate">Re-scan Messages</span>
            </Button>
          </div>
        ) : null}
          ...
          <div className="lg:col-span-2 w-full min-w-0">
            <Card className="h-full w-full">
              <CardHeader className="p-3 sm:p-6 pb-2">
                <CardTitle className="text-base sm:text-xl break-words">Spending Trends</CardTitle>
                <CardDescription className="text-xs sm:text-sm break-words">Your spending patterns over time</CardDescription>
              </CardHeader>
              <CardContent className="p-3 sm:p-6 pt-0">
        ...
        <Card className="w-full min-w-0">
          <CardHeader className="p-3 sm:p-6 pb-2">
            <CardTitle className="text-base sm:text-xl break-words">Recent Transactions</CardTitle>
            <CardDescription className="text-xs sm:text-sm break-words">Your latest financial activities</CardDescription>
          </CardHeader>
